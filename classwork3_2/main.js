...
for(i=0; i<listOfItems.length; i++){
    ...
    document.write(`<li class="list_top">${listOfItems[i]}</li>`)
...
for(i=0; i<simpsons.length; i++){
    ...
    document.write('INFO: ' + simpsons[i]["info"]);
        document.write(`<div class="img_simp2">`);
            document.write(`<img src="${simpsons[i].photo}">`);
        document.write(`</div>`);
    document.write(`</div>`);
}
